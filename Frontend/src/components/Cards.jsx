...
const Cards = ({_id,profileUrl,name,currentCompany,experiance,charges,description,profileImageURL}) => {
  return (
    <>
      <div className="card" style={{width : "18rem"}}>
        <img src={`http://localhost:3000/${profileImageURL}`} className="card-img-top" alt="..." />
